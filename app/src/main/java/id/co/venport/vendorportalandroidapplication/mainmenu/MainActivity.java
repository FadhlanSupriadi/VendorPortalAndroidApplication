...
public class MainActivity extends AppCompatActivity
    ...
    private PreferenceLogin preferenceIntro;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferenceIntro = new PreferenceLogin(this);
        if(!preferenceIntro.isProceedIn()){
            startActivity(new Intent(this, TampilanAwalActivity.class));
        }

        HashMap<String,String> user = preferenceIntro.getUserIntro();
